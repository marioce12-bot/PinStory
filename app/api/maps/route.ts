...
export async function POST(request: Request) {
  ...
  const mapRecord = {
    ...
    recipient_type: typeof data.recipient_type === "string" ? data.recipient_type : null,
    recipient_name: typeof data.recipient_name === "string" ? data.recipient_name.trim() : null,
  ...
  if (supabase) {
    const { error: mapError } = await supabase.from("maps").insert({
      ...
      recipient_type: mapRecord.recipient_type,
      recipient_name: mapRecord.recipient_name,
